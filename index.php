...
<html>
<head>
<title>Launch Page: Kaneenawup Character Generator</title>
...
<body>
	...
	<section>
        ...
        <br/>
            ...
            <br/>    
			<form action="" id ="kaneenawupForm"  target="_blank" method="post">
		...
		<div class="content8">
			  ...
			  <select id="level2" class="dropdownmenu2Iconic">
				<option value="01" selected>Kaneenawup, Level 1</option>
				<option value="02">Kaneenawup, Level 2</option>
				<option value="03">Kaneenawup, Level 3</option>
				<option value="04">Kaneenawup, Level 4</option>
				<option value="05">Kaneenawup, Level 5</option>
				<option value="06">Kaneenawup, Level 6</option>
				<option value="07">Kaneenawup, Level 7</option>
				<option value="08">Kaneenawup, Level 8</option>
				<option value="09">Kaneenawup, Level 9</option>
				<option value="10">Kaneenawup, Level 10</option>
			  </select>
        ...
        {
            $("#kaneenawupForm").attr('action', "kaneenawup/kaneenawup"+ $("#level2").val() +  ".php");
        });
