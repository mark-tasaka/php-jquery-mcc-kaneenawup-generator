...
<html>
<head>
<title>Iconic NPC Kaneenawup Character Generator</title>
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
	...
	<link rel="stylesheet" type="text/css" href="css/mcc_kaneenawup.css">
	<link rel="stylesheet" type="text/css" href="css/mcc_kaneenawup_post.css">
...
<!-- JQuery -->
  ...
  <script>
	...
	/*
	 Character() - Kaneenawup Character Constructor
	*/
	function Character() {
    ...
    let sentinel = getKaneenawup();
     ...
     /*getKaneenawup() return the statistics for the sentinel per level*/  
    function getKaneenawup() {
	let sentinel = [
	...
	return sentinel[0]; 
       ...
       let imgData = "images/kaneenawup_character_sheet.png";
